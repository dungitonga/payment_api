...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'transactions',  # Assuming 'transactions' is the app handling payment transactions
]
...
db_from_env = dj_database_url.config(default='postgresql://postgres:postgres@localhost:5432/<name_of_database>', conn_max_age=600)
